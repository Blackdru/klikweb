    ...
    <div className="w-full min-h-screen bg-black text-white py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-8 text-gray-200">
          <section>
            <h2 className="text-xl font-semibold text-purple-400 mb-4">1. Information Collection</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-purple-400 mb-4">2. Use of Data</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-purple-400 mb-4">3. Data Sharing</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-purple-400 mb-4">4. Cookies and Analytics</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-purple-400 mb-4">7. Changes to This Policy</h2>
            <p>
