...
export default function FAQ() {
  ...
  const faqs = [
    ...
    {
      question: "Who can play real-money games like klik games?",
    ...
    {
      question: "Why should u play Klik games?",
      answer: "Klik games offers a unique blend of entertainment and earning opportunities with a secure platform and active community."
    },
    {
      question: "Who are the Klik games founders?",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900/40 via-black to-purple-900/40 text-white py-16 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div>
            <h3 className="text-2xl font-bold mb-2">Rate KLiK Games</h3>
