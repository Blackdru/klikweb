    ...
    <div className="w-full min-h-screen bg-black text-white py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-8 text-gray-200">
          ...
          <section>
            <h2 className="text-xl font-semibold text-purple-400 mb-4">2. Eligibility</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-purple-400 mb-4">3. Game Rules</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-purple-400 mb-4">4. Account and Funds</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-purple-400 mb-4">5. Responsible Gambling</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-purple-400 mb-4">6. Prohibited Use</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-purple-400 mb-4">7. Modifications</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-purple-400 mb-4">8. Contact</h2>
            <p>
        ...
        <div className="mt-12 text-center text-sm text-gray-400">
          ...
          <div className="mt-6">
            <Link to="/" className="text-purple-400 hover:underline">Return to Home</Link>
          </div>
        </div>
      </div>
    </div>
